...
v_lead = [20; 20];%velocityoftheleader
...
for i = 1:N-1
    ...
    udot        = 10*u_dash - 8*u(3:6,i);%consensus NI controller
    %controller(s) = 1/(s+1)
    ...
    u(1:2,i+1) = v_des + alpha*e_ref + c_avoid*avoid1; % Update leader's velocity based on avoidance
