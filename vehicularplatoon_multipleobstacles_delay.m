...
for i = 6:N-1
   ...
   u(3:6,i+1) = u(3:6,i+1) + c_avoid_2*[avoid2; avoid3];%updated velocities with avoid states
    ...
    X(3:4,i+1) = X(3:4,i) + dt*u(3:4,i-2);%final position for the instant delayed by 2 instants
    X(5:6,i+1) = X(5:6,i) + dt*u(5:6,i-5);%final position for the instant delayed by 6 instants
end
